...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('modules/publish/fontawesome/css/all.min.css') }}">
    ...
    <link rel="alternate" type="application/rss+xml" title="Couchly Demo &raquo; Feed"
        href="https://demos.codezeel.com/wordpress/WCM08/WCM080193/default/feed/" />
    <link rel="alternate" type="application/rss+xml" title="Couchly Demo &raquo; Comments Feed"
        href="https://demos.codezeel.com/wordpress/WCM08/WCM080193/default/comments/feed/" />
    <script>
    ...
    <link rel='stylesheet' id='woosw-frontend-css'
        href="{{ asset('modules/publish/css/frontend-smart-wishlist.css?ver=4.9.8') }}" media='all' />
    ...
    <style id='base-global-inline-css'>
        ...
        :root {
            ...
            --global-palette-btn: var(--global-palette9);
            --global-palette-btn-hover: var(--global-palette9);
            --global-body-font-family: 'Roboto', Helvetica, Arial, sans-serif;
    ...
    <link rel='stylesheet' id='widget-divider-css'
        href="{{ asset('modules/publish/css/widget-divider.min.css?ver=3.27.6') }}" media='all' />
    <link rel='stylesheet' id='e-animation-grow-css'
        href="{{ asset('modules/publish/css/e-animation-grow.min.css?ver=3.27.6') }}" media='all' />
    ...
    <link rel='stylesheet' id='elementor-post-2-css'
        href="{{ asset('modules/publish/css/post-2.css?ver=1740652733') }}" media='all' />
    ...
    <link rel='stylesheet' id='tmcore-woocommerce-style-css'
        href="{{ asset('modules/publish/css/woocommerce-core.min.css?ver=3.4.0') }}" media='all' />
    <link rel='stylesheet' id='wp-block-library-css'
        href="{{ asset('modules/publish/css/style.min.css?ver=6.7.2') }}" media='all' />
    ...
    <link rel='stylesheet' id='couchly-layout-style-css'
        href="{{ asset('modules/publish/css/style2.css?ver=1.1.0') }}" media='all' />
    <link rel='stylesheet' id='google-fonts-1-css'
        href='https://fonts.googleapis.com/css?family=Roboto%3A100%2C100italic%2C200%2C200italic%2C300%2C300italic%2C400%2C400italic%2C500%2C500italic%2C600%2C600italic%2C700%2C700italic%2C800%2C800italic%2C900%2C900italic%7CRoboto+Slab%3A100%2C100italic%2C200%2C200italic%2C300%2C300italic%2C400%2C400italic%2C500%2C500italic%2C600%2C600italic%2C700%2C700italic%2C800%2C800italic%2C900%2C900italic%7CLora%3A100%2C100italic%2C200%2C200italic%2C300%2C300italic%2C400%2C400italic%2C500%2C500italic%2C600%2C600italic%2C700%2C700italic%2C800%2C800italic%2C900%2C900italic&#038;display=swap&#038;ver=6.7.2')}}"
        media='all' />
...
<body
    ...
    <div id="woosw_wishlist" class="woosw-popup woosw-popup-center">
    ...
    <link href="https://fonts.googleapis.com/css?family=Lora:400%2C500%7CRoboto:400&display=swap" rel="stylesheet"
    ...
    <div id="mobile-drawer"
        ...
        <div class="drawer-inner">
            ...
            <div class="drawer-content mobile-drawer-content content-align-left content-valign-top">
                        ...
                        <div class="mobile-menu-container drawer-menu-container">
                            <ul id="mobile-menu" class="menu has-collapse-sub-nav">
                                <li
                                    ...
                                    <a href="https://demos.codezeel.com/wordpress/WCM08/WCM080193/default/"
                                        aria-current="page">Trang chủ</a>
                                </li>
                                <li
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-64 base-menu-mega-enabled base-menu-mega-width-content base-menu-mega-columns-4 base-menu-mega-layout-equal">
                                    <div class="drawer-nav-drop-wrap"><a href="#">Gạch ốp lát</a><button
                                            class="drawer-sub-toggle" data-toggle-duration="10"
                                            data-toggle-target="#mobile-menu .menu-item-64 &gt; .sub-menu"
                                            aria-expanded="false"><span class="screen-reader-text">Toggle child
                                                menu</span><span class="base-svg-iconset"><svg aria-hidden="true"
                                                    class="base-svg-icon base-arrow-down-svg" fill="currentColor"
                                    ...
                                    <ul class="sub-menu">
                                        <li
                                            ...
                                            <div class="drawer-nav-drop-wrap"><a href="#">Gạch Vglacera</a>
                                                <button class="drawer-sub-toggle" data-toggle-duration="10"
                                                    data-toggle-target="#mobile-menu .menu-item-65 &gt; .sub-menu"
                                                    aria-expanded="false">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1048">
                                                    <a href="#">Grouped product</a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1075">
                                                    <a href="#">Variable Products<span
                                                            class="menu-highlight-item has-text-highlight"
                                                            style="color:#199588;  background:rgba(25,149,136,0.13);">NEW</span></a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-262">
                                                    <a href="#">External/Affiliate Product</a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1050">
                                                    <a href="#">Sale Products<span
                                                            class="menu-highlight-item has-text-highlight"
                                                            style="color:#e62a65;  background:rgba(230,42,101,0.13);">SALE</span></a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1054">
                                                    <a href="#">Upsell Product</a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1055">
                                                    <a href="#">Cross-Sell Product</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li
                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-66">
                                            <div class="drawer-nav-drop-wrap"><a href="#">Gạch Prime</a>
                                                <button class="drawer-sub-toggle" data-toggle-duration="10"
                                                    data-toggle-target="#mobile-menu .menu-item-66 &gt; .sub-menu"
                                                    aria-expanded="false">
                                                    <span class="screen-reader-text">Toggle child menu</span>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li
                                                    ...
                                                    <a href="#">Shop Ajax Filter<span
                                                            class="menu-highlight-item has-text-highlight"
                                                            style="color:#fc5934;  background:rgba(252,89,52,0.13);">HOT</span></a>
                                                </li>
                                                <li
                                                ...
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-1057">
                                                    <a rel="privacy-policy" href="#">Privacy Policy</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li
                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1058">
                                            <div class="drawer-nav-drop-wrap">
                                                <a href="#">Product Features</a><button
                                                    class="drawer-sub-toggle" data-toggle-duration="10"
                                                    data-toggle-target="#mobile-menu .menu-item-1058 &gt; .sub-menu"
                                                    aria-expanded="false">
                                                    <span class="screen-reader-text">Toggle child menu</span>
                                                    <span class="base-svg-iconset">
                                                        <svg aria-hidden="true"
                                            ...
                                            <ul class="sub-menu">
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1059">
                                                    <a href="#">Stock Progress Bar</a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1060">
                                                    <a href="#">Color/Image Swatches</a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1064">
                                                    <a href="#">Size Guide Table<span
                                                            class="menu-highlight-item has-text-highlight"
                                                            style="color:#fc5934;  background:rgba(252,89,52,0.13);">POPULAR</span></a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1065">
                                                    <a href="#">Custom Tab</a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1066">
                                                    <a href="#">Countdown Timer</a>
                                                </li>
                                                <li
                                                    class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1067">
                                                    <a href="#">Product Video<span
                                                            class="menu-highlight-item has-text-highlight"
                                                            style="color:#e62a65;  background:rgba(230,42,101,0.13);">FEATURED</span></a>
                                                </li>
                                                <li
                ...
                <div class="site-header-item site-header-focus-item site-header-item-mobile-navigation mobile-secondary-navigation-layout-stretch-false"
                    data-section="base_customizer_mobile_secondary_navigation">
                    <nav id="mobile-secondary-site-navigation"
                        class="mobile-navigation mobile-secondary-navigation drawer-navigation drawer-navigation-parent-toggle-false"
                        role="navigation" aria-label="Secondary Mobile Navigation">
                        <div class="mobile-menu-container drawer-menu-container">
                            <ul id="mobile-secondary-menu" class="menu has-collapse-sub-nav">
                                ...
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-90"><a
                                        href="#">Blog</a></li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-92"><a
    ...
    <script src="{{ asset('modules/publish/js/frontend2.js?ver=6.4.4') }}" id="woosc-frontend-js"></script>
    ...
    <script src="{{ asset('modules/publish/js/frontend3.js?ver=4.9.8') }}" id="woosw-frontend-js"></script>
    ...
    <script id="elementor-frontend-js-before">
        var elementorFrontendConfig = {
            ...
            "nonces": {
                "floatingButtonsClickTracking": "cd0230fc2b"
            },
            "swiperClass": "swiper",
            "settings": {
                "page": [],
    ...
    <script src="{{ asset('modules/publish/js/product-categories.min.js?ver=3.4.0') }}"
        id="tmcore-elementor-product-categories-js"></script>
    <script src="{{ asset('modules/publish/js/posts-grid.min.js?ver=3.4.0') }}" id="tmcore-elementor-posts-grid-js">
    </script>
    <script src="{{ asset('modules/publish/js/brand.min.js?ver=3.4.0') }}" id="tmcore-elementor-brand-js"></script>
        ...
        RS_MODULES.modules["revslider11"] = {
            ...
            init: function() {
                ...
                revapi1.revolutionInit({
                    ...
                    gridheight: "550,360,300,190",
                    lazyType: "smart",
                    spinner: "spinner0",
                    perspective: 600,
                    perspectiveType: "global",
                    editorheight: "550,360,300,190",
    ...
    {{-- <script>
        jQuery(document).ready(function() {
            ...
            jQuery('.header-cart-inner-wrap').click(function() {


                jQuery(".mini-cart-container").load('{{ route('website.minicart') }}');
            ...
            function delItem(id) {
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        jQuery(".mini-cart-container").load('{{ route('website.minicart') }}');
                        jQuery('.header-cart-total').html(data['cart_qty']);
