...
<head>
    ...
    <link rel='stylesheet' id='base-header-css' href="{{ asset('modules/publish//css/header.min.css?ver=1.5.3') }}"
        media='all' />
    <link rel='stylesheet' id='base-content-css'
        href="{{ asset('modules/publish//css/content.min.css?ver=1.5.3') }}" media='all' />
    ...
    <link rel='stylesheet' id='base-glightbox-css'
        href="{{ asset('modules/publish//css/glightbox.css?ver=3.4.0') }}" media='all' />
...
<body
    ...
    <script src="{{ asset('modules/publish//js/product-cls.min.js?ver=1.5.3') }}" id="base-product-cls-js"></script>
    <script src="{{ asset('modules/publish//js/single-ajax-add-to-cart.min.js?ver=3.4.0') }}"
        id="base-single-ajax-add-js"></script>
    <script src="{{ asset('modules/publish//js/base-sticky-add-to-cart.min.js?ver=3.4.0') }}"
        id="base-sticky-add-to-cart-js"></script>
    <script src="{{ asset('modules/publish//js/single-product.min.js?ver=9.7.0') }}" id="wc-single-product-js" defer
        data-wp-strategy="defer"></script>
    <script src="{{ asset('modules/publish//js/jquery.elevateZoom.min.js?ver=3.4.0') }}"
        id="base-product-gallery-zoom-js"></script>
    ...
    <script src="{{ asset('modules/publish//js/frontend-modules.min.js?ver=3.27.6') }}"
    ...
    <script src="{{ asset('modules/publish//js/elementor-frontend.min.js?ver=3.4.0') }}"
        id="tmcore-elementor-frontend-js"></script>
