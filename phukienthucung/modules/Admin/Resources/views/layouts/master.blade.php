...
<head>
    ...
    <head>
        ...
        <!-- [Favicon] icon -->
        {{-- <link rel="icon" href="{{ asset('modules/admin/images/favicon.svg') }}" type="image/x-icon"> --}}
        <!-- [Google Font] Family -->
        <link rel="stylesheet"
...
<body>
    ...
    {{-- Các file script js --}}
    <script src="{{ asset('modules/admin/js/plugins/apexcharts.min.js') }}"></script>
    <script src="{{ asset('modules/admin/js/pages/dashboard-default.js') }}"></script>
