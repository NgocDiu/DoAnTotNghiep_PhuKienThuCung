    ...
    @foreach ($employees as $employee)
        ...
        <div class="modal fade" id="editModal{{ $employee->id }}" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <form method="POST" action="{{ route('admin.employees.update', $employee->id) }}" class="needs-validation"
                    novalidate>
                    @csrf
                    @method('PUT')
                    <div class="modal-content">
                        ...
                        <div class="modal-body row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="invalid-feedback">Vui lòng mật khẩu và xác nhận mật khẩu phải khớp nhau.</div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            forms.forEach(form => {
                form.addEventListener('submit', function(event) {
                    form.classList.add('was-validated'); // Bootstrap validation
            ...
            // Khi mở modal thì reset validation để tránh báo lỗi cũ
            ...
            modals.forEach(modal => {
                modal.addEventListener('show.bs.modal', function() {
                    ...
                    if (form) {
                        ...
                        const invalids = form.querySelectorAll('.is-invalid, .is-valid');
                        invalids.forEach(input => input.classList.remove('is-invalid', 'is-valid'));
                    }
                });
            });
        });
